...
vi.mock('gsap', () => ({
  gsap: {
    ...
    timeline: vi.fn(() => ({
      ...
      fromTo: vi.fn(function(this: unknown) { return this }),
      kill: vi.fn(),
    })),
    killTweensOf: vi.fn(),
  },
...
describe('Accessibility Regression Tests', () => {
  ...
  describe('Focus Trap - CharmUnlockModal', () => {
    it('has focusable elements', () => {
      ...
      renderWithProviders(
        <CharmUnlockModal charm={testCharm} onDismiss={onDismiss} />
      )
  ...
  describe('Focus Trap - RedeemSuccessModal', () => {
    it('has focusable close button', () => {
      ...
      render(
        <RedeemSuccessModal isOpen={true} onClose={onClose} />
      )
  ...
  describe('ARIA Labels - Icon Buttons', () => {
    ...
    it('CharmCard aria-pressed updates on flip', () => {
      ...
      r(
        <CharmCard charm={testCharm} isFlipped={true} onFlip={vi.fn()} />
      )
