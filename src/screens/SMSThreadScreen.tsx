...
export function SMSThreadScreen() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center px-6 py-8 pb-0">
      ...
      {/* Main SMS Container */}
      <div className="relative z-10 flex w-full max-w-md flex-col bg-white/95 border-[3px] border-deep-black rounded-xl shadow-[8px_8px_0px_#131315] overflow-hidden h-[550px]">
        <SMSHeader />
        ...
        <div className="flex-1 bg-gray-50 p-4 space-y-5 overflow-y-auto relative font-pixel text-lg">
          ...
          <div
            ...
            style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg width=\"20\" height=\"20\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Crect width=\"20\" height=\"20\" fill=\"none\" stroke=\"%23888\" stroke-width=\"0.5\"/%3E%3C/svg%3E')" }}
          />
      ...
      {/* Gift Card Modal */}
      {showGiftModal && (
        <GiftCardModal onClose={handleCloseModal} />
      )}
    </div>
  )
}
