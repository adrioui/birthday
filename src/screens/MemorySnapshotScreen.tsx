...
export function MemorySnapshotScreen() {
    ...
    return (
      <div className="flex min-h-dvh flex-col bg-deep-black items-center justify-center p-4">
        <div className="text-bg-plate-dark px-6 py-4 rounded-xl mb-4">
          <div className="font-pixel text-xl text-pink">
            ERROR
          </div>
          <div className="font-pixel text-sm text-white/80 mt-2">
            {error}
          </div>
        </div>
        <button
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-deep-black overflow-hidden">
      ...
      <div className="relative z-50 w-full p-6 pb-12 bg-gradient-to-t from-periwinkle-dark/90 via-periwinkle-dark/50 to-transparent flex flex-col items-center justify-center gap-4">
        {isGenerating ? (
          <div className="text-bg-plate-dark inline-block px-6 py-3 rounded-xl">
            <div className="font-pixel text-xl text-lime animate-pulse">
              GENERATING SNAPSHOT...
